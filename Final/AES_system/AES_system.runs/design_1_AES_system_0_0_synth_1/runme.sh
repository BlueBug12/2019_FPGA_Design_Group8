...
HD_PWD='D:/FPGA/AES_system/AES_system.runs/design_1_AES_system_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_AES_system_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_AES_system_0_0.tcl
