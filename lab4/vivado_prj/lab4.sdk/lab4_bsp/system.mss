...
BEGIN DRIVER
 PARAMETER DRIVER_NAME = hash
 PARAMETER DRIVER_VER = 1.0
 PARAMETER HW_INSTANCE = hash_0
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = parity2
 PARAMETER DRIVER_VER = 1.0
 PARAMETER HW_INSTANCE = parity2_0
END
...
BEGIN DRIVER
 PARAMETER DRIVER_NAME = sorting
 PARAMETER DRIVER_VER = 1.0
 PARAMETER HW_INSTANCE = sorting_0
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = calculator
 PARAMETER DRIVER_VER = 1.0
 PARAMETER HW_INSTANCE = calculator_0
END
